package in.etbot.repository;

import in.etbot.Application;

import in.etbot.config.Constants;
import in.etbot.config.audit.AuditEventConverter;
import in.etbot.domain.PersistentAuditEvent;
...
import static in.etbot.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
