package in.etbot.web.rest;

import in.etbot.Application;
import in.etbot.config.Constants;
import in.etbot.domain.User;
import in.etbot.repository.AuthorityRepository;
import in.etbot.repository.UserRepository;
import in.etbot.security.AuthoritiesConstants;
import in.etbot.service.UserService;
import in.etbot.service.dto.PasswordChangeDTO;
import in.etbot.service.dto.UserDTO;
import in.etbot.web.rest.vm.KeyAndPasswordVM;
import in.etbot.web.rest.vm.ManagedUserVM;
...
import static in.etbot.web.rest.AccountResourceIT.TEST_USER_LOGIN;
